...
| A19 | UI-architecture ADR (surface model, input consumption, text input/focus, scroll primitive, screen-data contract per D14) | **Design deliverable, blocks U5 and T3** | D14, D15 (UI-1/2/5) |
