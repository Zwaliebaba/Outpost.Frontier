...
| `GameData/` | Content: `Meshes/` (OBJ/MTL), `Universe/` (JSON, generated by the bake), `Economy/` (JSON, authored — the balance content ADR-012 §D13 anticipated), `Audio/` (WAV + bank JSON). |
